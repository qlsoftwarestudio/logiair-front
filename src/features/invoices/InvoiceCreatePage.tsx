...
export default function InvoiceCreatePage() {
  ...
  // Filter AWBs by selected customer
        ...
        <div className="glass-card p-6 space-y-5">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div className="space-y-2">
              ...
              <Input value={form.invoiceNumber} onChange={(e) => setForm({ ...form, invoiceNumber: e.target.value })} placeholder="FAC-2024-001" className="bg-secondary border-border" required />
            </div>
            <div className="space-y-2">
              <Label>Cliente *</Label>
          ...
          <div className="space-y-2">
            ...
            <Textarea value={form.observations} onChange={(e) => setForm({ ...form, observations: e.target.value })} placeholder="Observaciones opcionales..." className="bg-secondary border-border" rows={2} />
          </div>
        </div>
